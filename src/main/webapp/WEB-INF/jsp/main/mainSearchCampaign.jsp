...
<div class="my-modal search-modal" aria-hidden="true" 
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form:checkbox path="statusOpen"
      	cssClass="form-check-input checkbox-brink-red"/>
      <form:label path="statusOpen"
      	cssClass="form-check-label label-brink-red">Open</form:label>
      <form:checkbox path="statusClosed"
      	cssClass="form-check-input checkbox-brink-red"/>
      <form:label path="statusClosed"
      	cssClass="form-check-label label-brink-red">Closed</form:label>
      </div>
