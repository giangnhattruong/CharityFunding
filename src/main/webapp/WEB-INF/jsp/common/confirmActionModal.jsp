...
<div class="my-modal confirm-action-modal" 
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content" style="height: 60vh; width: 60vw;">
      <div class="modal-header border-0">
      	<p class="text-center h3">Are you sure to 
	      	<span id="modalAction" class="text-lowercase"></span>
	      	 these ${param.itemLabel}(s):</p>
      ...
      <div class="modal-footer border-0">
        ...
        <button id="modal-action-btn" class="btn btn-danger">
        	<span id="modalActionBtn"></span></button>
      </div>
    </div>
  </div>
</div>